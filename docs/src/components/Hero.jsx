    ...
    <section className="w-full flex flex-col items-center pt-24 pb-16 px-4 text-center relative overflow-hidden">
      ...
      <div className="mt-16 max-w-4xl mx-auto z-10 relative">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="https://github.com/RavaniRoshan/SKILLS-for-terminal-linux-env/tree/master" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white text-brand-navy border-2 border-brand-navy/10 hover:border-brand-navy px-8 py-4 rounded-full font-bold text-lg transition-all hover:-translate-y-1">
            View on GitHub
          </a>
        </div>
      </div>
